//https://github.com/jiahaoliuliu/DrawerWithTabsAndViewPager/blob/master/src/com/jiahaoliuliu/tabswipe/MainActivity.java
...
public class MainDrawer extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        Fragment fragment = calculateFragment(position);
    ...
    private Fragment calculateFragment(int position) {
        switch (position) {
            case 0:
